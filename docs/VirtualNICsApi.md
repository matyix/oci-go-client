...
------------- | ------------- | -------------
[**GetVirtualNIC**](VirtualNICsApi.md#GetVirtualNIC) | **Get** /network/v1/vnic/{name} | Retrieve Details of a Virtual NIC
[**ListVirtualNIC**](VirtualNICsApi.md#ListVirtualNIC) | **Get** /network/v1/vnic/{container}/ | Retrieve Details of all Virtual NICs in a Container


# **GetVirtualNIC**
> VirtualNicResponse GetVirtualNIC($name, $cookie)
...
# **ListVirtualNIC**
> VirtualNicListResponse ListVirtualNIC($container, $cookie)
