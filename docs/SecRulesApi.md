...
------------- | ------------- | -------------
[**AddSecRule**](SecRulesApi.md#AddSecRule) | **Post** /secrule/ | Create a Security Rule
[**DeleteSecRule**](SecRulesApi.md#DeleteSecRule) | **Delete** /secrule/{name} | Delete a Security Rule
[**DiscoverRootSecRule**](SecRulesApi.md#DiscoverRootSecRule) | **Get** /secrule/ | Retrieve Names of Containers
[**DiscoverSecRule**](SecRulesApi.md#DiscoverSecRule) | **Get** /secrule/{container} | Retrieve Names of all Security Rules and Subcontainers in a Container
[**GetSecRule**](SecRulesApi.md#GetSecRule) | **Get** /secrule/{name} | Retrieve Details of a Security Rule
[**ListSecRule**](SecRulesApi.md#ListSecRule) | **Get** /secrule/{container}/ | Retrieve Details of all Security Rules in a Container
[**UpdateSecRule**](SecRulesApi.md#UpdateSecRule) | **Put** /secrule/{name} | Update a Security Rule


# **AddSecRule**
> SecRuleResponse AddSecRule($body, $cookie)
...
# **DiscoverRootSecRule**
> SecRuleDiscoverResponse DiscoverRootSecRule($cookie)
...
# **DiscoverSecRule**
> SecRuleDiscoverResponse DiscoverSecRule($container, $cookie)
...
# **GetSecRule**
> SecRuleResponse GetSecRule($name, $cookie)
...
# **ListSecRule**
> SecRuleListResponse ListSecRule($container, $dstList, $description, $srcList, $disabled, $application, $name, $cookie)
...
# **UpdateSecRule**
> SecRuleResponse UpdateSecRule($name, $body, $cookie)
