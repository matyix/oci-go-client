...
------------- | ------------- | -------------
[**AddSecIPList**](SecIPListsApi.md#AddSecIPList) | **Post** /seciplist/ | Create a Security IP List
[**DeleteSecIPList**](SecIPListsApi.md#DeleteSecIPList) | **Delete** /seciplist/{name} | Delete a Security IP List
[**DiscoverRootSecIPList**](SecIPListsApi.md#DiscoverRootSecIPList) | **Get** /seciplist/ | Retrieve Names of Containers
[**DiscoverSecIPList**](SecIPListsApi.md#DiscoverSecIPList) | **Get** /seciplist/{container} | Retrieve Names of all Security IP Lists and Subcontainers in a Container
[**GetSecIPList**](SecIPListsApi.md#GetSecIPList) | **Get** /seciplist/{name} | Retrieve Details of a Security IP List
[**ListSecIPList**](SecIPListsApi.md#ListSecIPList) | **Get** /seciplist/{container}/ | Retrieve Details of all Security IP Lists in a Container
[**UpdateSecIPList**](SecIPListsApi.md#UpdateSecIPList) | **Put** /seciplist/{name} | Update a Security IP List


# **AddSecIPList**
> SecIpListResponse AddSecIPList($body, $cookie)
...
------------- | ------------- | ------------- | -------------
 **body** | [**SecIpListPostRequest**](SecIpListPostRequest.md)|  | 
...
[**SecIpListResponse**](SecIPList-response.md)
...
# **DiscoverRootSecIPList**
> SecIpListDiscoverResponse DiscoverRootSecIPList($cookie)
...
[**SecIpListDiscoverResponse**](SecIPList-discover-response.md)
...
# **DiscoverSecIPList**
> SecIpListDiscoverResponse DiscoverSecIPList($container, $cookie)
...
# **GetSecIPList**
> SecIpListResponse GetSecIPList($name, $cookie)
...
# **ListSecIPList**
> SecIpListListResponse ListSecIPList($container, $name, $cookie)
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **container** | **string**| &lt;p&gt;&lt;code&gt;/Compute-&lt;em&gt;identity_domain&lt;/em&gt;/&lt;em&gt;user&lt;/em&gt;&lt;/code&gt; and &lt;code&gt;/Compute-&lt;em&gt;identity_domain&lt;/em&gt;/&lt;/code&gt;for user-defined security IP lists and &lt;code&gt;/oracle/public&lt;/code&gt; for the predefined public-internet security IP list.&lt;/p&gt; | 
 **name** | **string**| &lt;p&gt;The three-part name of the object (&lt;code&gt;/Compute-&lt;em&gt;identity_domain&lt;/em&gt;/&lt;em&gt;user&lt;/em&gt;/&lt;em&gt;object&lt;/em&gt;&lt;/code&gt; or &lt;code&gt;/oracle/public/&lt;em&gt;object&lt;/em&gt;&lt;/code&gt;.) | [optional] 
 **cookie** | **string**| The Cookie: header must be included with every request to the service. It must be set to the value of the set-cookie header in the response received to the POST /authenticate/ call. | [optional] 

### Return type

[**SecIpListListResponse**](SecIPList-list-response.md)
...
# **UpdateSecIPList**
> SecIpListResponse UpdateSecIPList($name, $body, $cookie)
...
------------- | ------------- | ------------- | -------------
 **name** | **string**| &lt;p&gt;The three-part name of the object (&lt;code&gt;/Compute-&lt;em&gt;identity_domain&lt;/em&gt;/&lt;em&gt;user&lt;/em&gt;/&lt;em&gt;object&lt;/em&gt;&lt;/code&gt;). | 
 **body** | [**SecIpListPutRequest**](SecIpListPutRequest.md)|  | 
 **cookie** | **string**| The Cookie: header must be included with every request to the service. It must be set to the value of the set-cookie header in the response received to the POST /authenticate/ call. | [optional] 
