...
------------- | ------------- | -------------
[**DiscoverAccount**](AccountsApi.md#DiscoverAccount) | **Get** /account/{container} | Retrieve Names of all Accounts and Subcontainers in a Container
...
# **DiscoverAccount**
> AccountDiscoverResponse DiscoverAccount($container, $cookie)
...
# **DiscoverRootAccount**
> AccountDiscoverResponse DiscoverRootAccount($cookie)
...
# **GetAccount**
> AccountResponse GetAccount($name, $cookie)
...
# **ListAccount**
> AccountListResponse ListAccount($container, $cookie)
