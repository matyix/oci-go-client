...
[**DiscoverIPReservation**](IPReservationsApi.md#DiscoverIPReservation) | **Get** /ip/reservation/{container} | Retrieve Names of all IP Reservations and Subcontainers in a Container
...
# **AddIPReservation**
> IpReservationResponse AddIPReservation($body, $cookie)
...
# **DeleteIPReservation**
> DeleteIPReservation($name, $cookie)
...
> IpReservationDiscoverResponse DiscoverIPReservation($container, $cookie)
...
> IpReservationDiscoverResponse DiscoverRootIPReservation($cookie)
...
# **GetIPReservation**
> IpReservationResponse GetIPReservation($name, $cookie)
...
# **ListIPReservation**
> IpReservationListResponse ListIPReservation($container, $permanent, $used, $tags, $cookie)
...
# **UpdateIPReservation**
> IpReservationResponse UpdateIPReservation($name, $body, $cookie)
