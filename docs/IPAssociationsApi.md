...
[**DiscoverIPAssociation**](IPAssociationsApi.md#DiscoverIPAssociation) | **Get** /ip/association/{container} | Retrieve Names of all IP Associations and Subcontainers in a Container
...
# **AddIPAssociation**
> IpAssociationResponse AddIPAssociation($body, $cookie)
...
# **DeleteIPAssociation**
> DeleteIPAssociation($name, $cookie)
...
> IpAssociationDiscoverResponse DiscoverIPAssociation($container, $cookie)
...
> IpAssociationDiscoverResponse DiscoverRootIPAssociation($cookie)
...
# **GetIPAssociation**
> IpAssociationResponse GetIPAssociation($name, $cookie)
...
# **ListIPAssociation**
> IpAssociationListResponse ListIPAssociation($container, $parentpool, $reservation, $vcable, $enabled, $cookie)
 ...
 **enabled** | **bool**| Start the NAT Connection in enabled state. In disabled state networking will be torn down | [optional] 
 **cookie** | **string**| The Cookie: header must be included with every request to the service. It must be set to the value of the set-cookie header in the response received to the POST /authenticate/ call. | [optional] 
