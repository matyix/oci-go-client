...
------------- | ------------- | -------------
[**AddRoute**](RoutesApi.md#AddRoute) | **Post** /network/v1/route/ | Create a Route
[**DeleteRoute**](RoutesApi.md#DeleteRoute) | **Delete** /network/v1/route/{name} | Delete a Route
[**GetRoute**](RoutesApi.md#GetRoute) | **Get** /network/v1/route/{name} | Retrieve Details of a Route
[**ListRoute**](RoutesApi.md#ListRoute) | **Get** /network/v1/route/{container}/ | Retrieve Details of all Routes in a Container
[**UpdateRoute**](RoutesApi.md#UpdateRoute) | **Put** /network/v1/route/{name} | Update a Route


# **AddRoute**
> RouteResponse AddRoute($body, $cookie)
...
# **GetRoute**
> RouteResponse GetRoute($name, $cookie)
...
# **ListRoute**
> RouteListResponse ListRoute($container, $cookie)
...
# **UpdateRoute**
> RouteResponse UpdateRoute($name, $body, $cookie)
