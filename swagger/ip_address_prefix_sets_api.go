...
type IPAddressPrefixSetsApi struct {
	Configuration *Configuration
}

func NewIPAddressPrefixSetsApi() *IPAddressPrefixSetsApi {
	configuration := NewConfiguration()
	return &IPAddressPrefixSetsApi{
		Configuration: configuration,
	}
}

func NewIPAddressPrefixSetsApiWithBasePath(basePath string) *IPAddressPrefixSetsApi {
	configuration := NewConfiguration()
 ...
 * @return *IpAddressPrefixSetResponse
 */
func (a IPAddressPrefixSetsApi) AddIPAddressPrefixSet(body IpAddressPrefixSetPostRequest, cookie string) (*IpAddressPrefixSetResponse, *APIResponse, error) {

	var localVarHttpMethod = strings.ToUpper("Post")
	// create path and map variables
	localVarPath := a.Configuration.BasePath + "/network/v1/ipaddressprefixset/"
	...
	var successPayload = new(IpAddressPrefixSetResponse)
	localVarHttpResponse, err := a.Configuration.APIClient.CallAPI(localVarPath, localVarHttpMethod, localVarPostBody, localVarHeaderParams, localVarQueryParams, localVarFormParams, localVarFileName, localVarFileBytes)

	var localVarURL, _ = url.Parse(localVarPath)
	localVarURL.RawQuery = localVarQueryParams.Encode()
	var localVarAPIResponse = &APIResponse{Operation: "AddIPAddressPrefixSet", Method: localVarHttpMethod, RequestURL: localVarURL.String()}
 ...
 * @return void
 */
func (a IPAddressPrefixSetsApi) DeleteIPAddressPrefixSet(name string, cookie string) (*APIResponse, error) {

	var localVarHttpMethod = strings.ToUpper("Delete")
	// create path and map variables
	localVarPath := a.Configuration.BasePath + "/network/v1/ipaddressprefixset/{name}"
	...
	var localVarURL, _ = url.Parse(localVarPath)
	localVarURL.RawQuery = localVarQueryParams.Encode()
	var localVarAPIResponse = &APIResponse{Operation: "DeleteIPAddressPrefixSet", Method: localVarHttpMethod, RequestURL: localVarURL.String()}
	if localVarHttpResponse != nil {
		localVarAPIResponse.Response = localVarHttpResponse.RawResponse
		localVarAPIResponse.Payload = localVarHttpResponse.Body()
	}
 ...
 * @return *IpAddressPrefixSetResponse
 */
func (a IPAddressPrefixSetsApi) GetIPAddressPrefixSet(name string, cookie string) (*IpAddressPrefixSetResponse, *APIResponse, error) {
	...
	var localVarURL, _ = url.Parse(localVarPath)
	localVarURL.RawQuery = localVarQueryParams.Encode()
	var localVarAPIResponse = &APIResponse{Operation: "GetIPAddressPrefixSet", Method: localVarHttpMethod, RequestURL: localVarURL.String()}
	if localVarHttpResponse != nil {
		localVarAPIResponse.Response = localVarHttpResponse.RawResponse
		localVarAPIResponse.Payload = localVarHttpResponse.Body()
	}
 ...
 * @param cookie The Cookie: header must be included with every request to the service. It must be set to the value of the set-cookie header in the response received to the POST /authenticate/ call.
 * @return *IpAddressPrefixSetListResponse
 */
func (a IPAddressPrefixSetsApi) ListIPAddressPrefixSet(container string, cookie string) (*IpAddressPrefixSetListResponse, *APIResponse, error) {

	var localVarHttpMethod = strings.ToUpper("Get")
	// create path and map variables
	localVarPath := a.Configuration.BasePath + "/network/v1/ipaddressprefixset/{container}/"
	...
	// header params "Cookie"
	localVarHeaderParams["Cookie"] = a.Configuration.APIClient.ParameterToString(cookie, "")
	var successPayload = new(IpAddressPrefixSetListResponse)
	localVarHttpResponse, err := a.Configuration.APIClient.CallAPI(localVarPath, localVarHttpMethod, localVarPostBody, localVarHeaderParams, localVarQueryParams, localVarFormParams, localVarFileName, localVarFileBytes)

	var localVarURL, _ = url.Parse(localVarPath)
	localVarURL.RawQuery = localVarQueryParams.Encode()
	var localVarAPIResponse = &APIResponse{Operation: "ListIPAddressPrefixSet", Method: localVarHttpMethod, RequestURL: localVarURL.String()}
	if localVarHttpResponse != nil {
		localVarAPIResponse.Response = localVarHttpResponse.RawResponse
		localVarAPIResponse.Payload = localVarHttpResponse.Body()
	}
 ...
 * @return *IpAddressPrefixSetResponse
 */
func (a IPAddressPrefixSetsApi) UpdateIPAddressPrefixSet(name string, body IpAddressPrefixSetPutRequest, cookie string) (*IpAddressPrefixSetResponse, *APIResponse, error) {
	...
	var localVarURL, _ = url.Parse(localVarPath)
	localVarURL.RawQuery = localVarQueryParams.Encode()
	var localVarAPIResponse = &APIResponse{Operation: "UpdateIPAddressPrefixSet", Method: localVarHttpMethod, RequestURL: localVarURL.String()}
	if localVarHttpResponse != nil {
		localVarAPIResponse.Response = localVarHttpResponse.RawResponse
		localVarAPIResponse.Payload = localVarHttpResponse.Body()
	}
